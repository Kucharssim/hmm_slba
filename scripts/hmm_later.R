...
mcmc_hist(generated_data$draws(variables = "prop_state"))
mcmc_hist(generated_data$draws(variables = "prop_responses"))
mcmc_hist(generated_data$draws(variables = "mean_rt"))
